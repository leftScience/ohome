...
func InitConfig() {
	...
	viper.SetDefault("config.allowUserRegistration", false)
	viper.SetDefault("quark.transfer.workers", 2)
	viper.SetDefault("quark.transfer.queueSize", 32)
	...
	viper.SetDefault("update.manifestUrl", "")
